...
class DataProcessor:
    ...
    def filter_users(self,min_rating=400):
        try:
            ...
            logger.info("Filtered user sucessfully...")
        except Exception as e:
    ...
    def save_artifacts(self):
        try:
            ...
            logger.info("All the training data as well as rating_df is saved now...")
    ...
    def process_anime_data(self):
        try:
            ...
            logger.info("DF and SYNOPSIS_DF saved sucesfully...")
