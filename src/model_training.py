...
class ModelTraining:
    def __init__(self,data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key="XpJ8F2qFIWw9MW0zjQuRAOUzp",
            project_name="mlops-project-2",
            workspace="snehallaldas"
        )
    ...
    def load_data(self):
        try:
            ...
            logger.info("Data load sucessfully for model training ")
    ...
    def extract_weigths(self,name,model):
        try:
    ...
    def save_model_weights(self,model):
        try:
            ...
            logger.info("User and anime weights are saved succesfully")
